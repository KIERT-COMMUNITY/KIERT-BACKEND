...
public class SecurityConfig {
    ...
    // Rutas públicas: espejo de lo que el authGuard del frontend NO protege
    // (login, registro, recuperar/restablecer contraseña) + WebSocket handshake.
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Feed de publicaciones: lectura pública, escritura requiere sesión
    ...
    public PasswordEncoder passwordEncoder() {
        return new BCryptPasswordEncoder(); // BCrypt, tal como espera auth.service.ts en los comentarios
    }
